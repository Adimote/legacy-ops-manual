...
\end{enumerate}
These pieces of information are provided to teams through the ``competition software'', which is managed by the \roletitle{comp-sw-ops-coord}.  The match schedule must be available to teams before the competition begins.
