...
\begin{roledesc}{kit-sw-coord}
  ...
  \begin{responsibilities}
    \item{Development of kit related software including:
      \begin{itemize}
        \item{Software that will run on the kit hardware, e.g. firmware, and python libraries.}
        \item{Software that aids teams with developing their robots, e.g. IDEs, debuggers, and simulators.}
    ...
    \item{Providing support to teams on matters related to the kit software.}
  \end{responsibilities}
\end{roledesc}
...
\begin{roledesc}{kit-support-coord}
  \begin{responsibilities}
    ...
    \item Assess claims of broken Kit and authorise shipping of replacements where required.
  \end{responsibilities}
\end{roledesc}
