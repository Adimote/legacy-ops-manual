...
\begin{roledesc}{hw-dev-coord}
  \begin{responsibilities}
    ...
    \item{Writing supporting documentation for new hardware including:
        \begin{itemize}
...
\begin{roledesc}{hw-manu-coord}
  \begin{responsibilities}
    ...
    \item{Performing maintenance on existing hardware between the Competition and Kickstart.}
  \end{responsibilities}
\end{roledesc}
