...
\item Classes of kit
  \begin{enumerate}
    ...
    \item It is the responsibility of the \role{hw-manu-coord} to ensure that enough kits exist. Specifically the \role{hw-manu-coord} needs to ensure that there are more kits manufactured in preparation for the next competition programme year.
  \end{enumerate}
\end{enumerate}
