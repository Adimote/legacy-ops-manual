    ...
    \item General software development
      \begin{enumerate}
        \item Each piece of software, as defined by the \role{kit-sw-coord}, must maintain the following documentation alongside the source code:
          ...
          \end{enumerate}
        \item Prior to the release of a new version of the software the \role{kit-sw-coord} must verify that there are no new potential legal implications due to the new features and that all of the existing potential legal implications have been suitably dealt with.
