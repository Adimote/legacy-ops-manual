...
\item Development
  \begin{enumerate}
    ...
    \item A new kit item proposal is required when looking to develop new bits of kit. This proposal must include:
      ...
      \end{enumerate}
    \item Proposals for new kit development must be reviewed and accepted by the \role{kit-coord} before money is allocated for development.
    \item Once developed, a final kit addition proposal is required. This proposal must include:
      ...
      \end{enumerate}
    \item Final designs must be approved by the \role{kit-coord} before it enters into the kit and therefore manufacturing.
