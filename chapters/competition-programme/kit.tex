...
The kit provided by Student Robotics must provide teams with all of the parts, both physical and virtual, to allow them to easily construct a minimum viable robot - a robot which is capable of competing within the game. This minimum viable robot significantly lowers the barrier to entry and also allows teams to focus on the elements of their robot than interest them the most. The minimum viable robot will allow them to compete, but their own original work is what will help them to win.
