...
\section{Roles}
\begin{roledesc}{\subsection}{comp-prog-coord}
  The \roletitle{comp-prog-coord} is responsible for running the competition programme.
\end{roledesc}

\begin{roledesc}{\subsection}{head-treasurer}
  The \roletitle{head-treasurer} is responsible for managing the organisation's finances.  This includes:
  \begin{itemize}
...
\begin{roledesc}{\subsection}{pr-coord}
...
\begin{roledesc}{\subsection}{internet-owner}
...
\begin{roledesc}{\subsection}{welfare-coord}
