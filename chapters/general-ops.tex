...
\section{Roles}
\begin{roledesc}{FC}
The \RoleLong{FC} is responsible for ensuring the organisation has sufficient funds to function.
\end{roledesc}
\begin{roledesc}{VRC}
The \RoleLong{VRC} is responsible for recruiting new volunteers and helping them to find a position in the organisation that suits them best.
\end{roledesc}
