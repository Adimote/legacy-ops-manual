...
\item The \role{vol-rec-coord} will perform regular assessments of the volunteering requirements within the organisation, and adjust their recruitment strategies to suit current demand. (\textit{(This may move into the VRC role description in General Operations chapter)}).
