...
\begin{itemize}
\item Coordinated by the \role{VRC}
\item Volunteers may arrive at SR through a variety of routes.  If an existing volunteer meets someone who wishes to be a volunteer, they may:
  \begin{itemize}
  \item Refer them to the \role{VRC}.
...
\item The \role{VRC} will perform regular assessments of the volunteering requirements within the organisation, and adjust their recruitment strategies to suit current demand. (\textit{(This may move into the VRC role description in General Operations chapter)}).
